...
class DDGSearchLinksTool(BaseTool):
    name: str = "DuckDuckGoSearchLinks"
    description: str = "Useful for when you need more links to website that points to information about a TOPIC over the internet using DuckDuckGo."
